...
enum
{
    ...
    MODEL_PACKED_BLESS_OF_LIGHT = MODEL_WING + 144,
    ...
    MODEL_BLESS_OF_LIGHT = MODEL_POTION + 162,
...
enum
{
    ...
    ITEM_PACKED_BLESS_OF_LIGHT = ITEM_WING + 144,
    ...
    ITEM_BLESS_OF_LIGHT = ITEM_POTION + 162,
